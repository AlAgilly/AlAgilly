...
import { screenshot1, yorkb, yorkm, yorkw } from '../assets'
  ...
  return (
    <div className='App'>
        <div className='max-w-[1000px] m-auto justify-self-auto text-left items-center xs:px-10 px-8 my-24'>
            ...
            <p className='pb-3'>This website actually consists of two separate web apps; the front end (using React and TailwindCSS) and the back end (using Express and <a href="https://developers.notion.com/" className='link'>NotionAPI</a>). The back end (what i refer to as the server side application) fetches data from Notion (hourly for event and tournament times & dates and daily for staff, player and team information) using a <a href="https://crontab.guru/" className='link'>Cron scheduler</a>. Once the data is fetched, their respective files are updated and pushed to the web; from there, the front end (or client side application) grabs the required data when needed using <a href="https://axios-http.com/docs/intro" className='link'>Axios</a> and populates the website using reusable components.</p>
            ...
            <div className='grid grid-cols-2 gap-7'>
                ...
                <p className='pb-3'>The visual aspect of the website is a testament to the collaborative efforts of our skilled UI/UX designers. Their innovative design sensibilities have been expertly translated into a captivating user interface that navigates smoothly and intuitively. While the design team shaped the project's aesthetic, my main role was to bring their vision to life. My experience in development and implementation transformed design concepts into interactive reality, ensuring that every click and interaction resonates with the club's goals and the community it serves.</p>
            <p>The design and architecture of the YGE website were meticulously crafted to strike a harmonious balance between aesthetics and functionality. The intuitive user interface welcomes visitors with an immersive experience that encourages exploration. The website's architecture seamlessly integrates the frontend and backend technologies, ensuring that data flows effortlessly to provide real-time information to users. Through thoughtful layout design, intuitive navigation, and a vibrant color palette, the platform captures the energetic spirit of gaming and esports. Add something here about mobile responsiveness and accessibility</p>
